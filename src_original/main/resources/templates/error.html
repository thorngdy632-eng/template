...
<html lang="en">
	<head>
		...
		<!-- SITE TITLE -->
		<title>Purdue - Education HTML Template</title>			
					...
					<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
						<div class="top_social_profile">
							<ul>
								...
								<li><a href="#" class="top_f_twitter"><i class="fa-brands fa-square-x-twitter"></i></a></li>
			...
			<div class="row">
			  <div class="col-lg-12 col-sm-12 col-xs-12 text-center">
					<div class="error_page">
						...
						<div class="home_btn">
							<a href="index.html" class="btn_one">Back to Home</a>
						</div>	
					</div>
			  </div><!--- END COL -->				  
			</div><!--- END ROW -->
				...
				<div class="col-lg-3 col-sm-6 col-xs-12">
					...
					<div class="col-lg-2 col-sm-6 col-xs-12">
						<div class="single_footer">
							...
							<a href="index.html"><img src="assets/images/all-img/google-play.jpg" class="foot_img" alt=""></a>  
							<a href="index.html"><img src="assets/images/all-img/app-store.jpg" class="foot_img" alt=""></a>  
						</div>
					</div><!--- END COL -->					
			</div><!--- END ROW -->		
			<div class="row fc">
